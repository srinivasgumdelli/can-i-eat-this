  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created condition as @condition" do
        post :create, {:condition => valid_attributes}, valid_session
        expect(assigns(:condition)).to be_a(Condition)
        expect(assigns(:condition)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved condition as @condition" do
        post :create, {:condition => invalid_attributes}, valid_session
        expect(assigns(:condition)).to be_a_new(Condition)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested condition" do
        condition = Condition.create! valid_attributes
        put :update, {:id => condition.to_param, :condition => new_attributes}, valid_session
        condition.reload
    ...
    context "with invalid params" do
      it "assigns the condition as @condition" do
        condition = Condition.create! valid_attributes
        put :update, {:id => condition.to_param, :condition => invalid_attributes}, valid_session
        expect(assigns(:condition)).to eq(condition)
      end
